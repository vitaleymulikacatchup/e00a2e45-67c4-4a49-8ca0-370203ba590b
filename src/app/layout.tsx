...
export const metadata: Metadata = {
  title: "BrewHaven - Artisan Coffee Shop | Premium Brews",
  description: "Discover specialty single-origin coffee at BrewHaven. Artisan espresso, cold brew, and seasonal drinks in a welcoming atmosphere.",
  keywords: "coffee shop, specialty coffee, espresso, artisan coffee, cold brew, coffee drinks",
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "BrewHaven - Artisan Coffee Shop",
    description: "Experience premium artisan coffee crafted with passion. Visit BrewHaven today.",
    siteName: "BrewHaven",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34yEatLQt6B9A82mZgfqKsKaLO9/uploaded-1764586024764-soc5mlgo.jpg",
  ...
  twitter: {
    ...
    title: "BrewHaven - Artisan Coffee Shop",
    description: "Premium single-origin coffee in our cozy shop.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34yEatLQt6B9A82mZgfqKsKaLO9/uploaded-1764586024764-soc5mlgo.jpg"],
  },
};
